...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        title: "Реле",
        hint: "Позволяет сопряжённым устройствам подключаться к этому хосту откуда угодно. Пока параметр включён, демон поддерживает исходящее соединение с реле. Трафик остаётся зашифрованным сквозным образом; реле видит только метаданные соединения.",
        accessibilityLabel: "Соединение с реле",
        updateFailedTitle: "Не удалось изменить реле",
      },
      orchestration: {
        title: "оркестровка",
