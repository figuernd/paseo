...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    host: {
      ...
      relay: {
        title: "التتابع",
        hint: "يتيح للأجهزة المقترنة الوصول إلى هذا المضيف من أي مكان. تحافظ الخدمة على اتصال صادر بالتتابع أثناء تفعيله. تظل حركة البيانات مشفرة طرفًا إلى طرف؛ ولا يرى التتابع سوى بيانات وصفية عن الاتصال.",
        accessibilityLabel: "اتصال التتابع",
        updateFailedTitle: "تعذر تغيير التتابع",
      },
      orchestration: {
        title: "التنسيق",
